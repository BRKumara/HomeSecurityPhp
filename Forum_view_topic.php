...
<button style="margin-left: 1135px;"onclick="window.location.href = 'Forum.php'" type="submit" class="btn btn-success">Forum Home Page</button> 
...
<table width="400" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
<tr>
<form name="form1" method="post" action="Forum_Add_Answer.php">
<td>
...
<td valign="top">:</td>
<td><textarea name="a_answer" cols="46" rows="3" id="a_answer" required></textarea></td>
</tr>
<tr>
<td>&nbsp;</td>
